...
(1, "Rafael Cosentino", "cosentino@k19.com", 1.87, "11-08977-3300"),
(2, "Rafael Cosentino", "cosentino@k19.com", 1.87, "11-08977-3300"),
(3, "Jonas Hirata", "hirata@k19.com", 1.76, "11-91177-3300"),
(4, "Jonas Hirata", "hirata@k19.com", 1.76, "11-91177-3300");
...
#select a.nome AS nome_aluno, p.nomeprof AS nome_prof from aluno AS a, professor AS p;
...
#select * from aluno where nome not like '%Hirata';
